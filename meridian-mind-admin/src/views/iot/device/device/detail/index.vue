  ...
  <el-col>
    <el-tabs v-model="activeTab">
      <el-tab-pane label="设备信息" name="info">
        <DeviceDetailsInfo v-if="activeTab === 'info'" :device="device" :product="product" />
      </el-tab-pane>
      <el-tab-pane label="Topic 列表" />
      <el-tab-pane label="物模型数据" name="model">
        <DeviceDetailsModel v-if="activeTab === 'model'" :device="device" :product="product" />
      </el-tab-pane>
      <el-tab-pane v-if="product.deviceType === DeviceTypeEnum.GATEWAY" label="子设备管理" />
