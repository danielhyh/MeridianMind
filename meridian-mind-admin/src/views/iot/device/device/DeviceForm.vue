  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="DeviceKey" prop="deviceKey">
        ...
        >
          <template #append>
            <el-button :disabled="formType === 'update'" @click="generateDeviceKey">
              重新生成
            </el-button>
          </template>
        </el-input>
      ...
      <el-form-item
        ...
        prop="gatewayId"
      >
        <el-select v-model="formData.gatewayId" clearable placeholder="子设备可选择父设备">
          <el-option
      ...
      <el-collapse>
        <el-collapse-item title="更多配置">
          ...
          <el-form-item label="设备分组" prop="groupIds">
            <el-select v-model="formData.groupIds" clearable multiple placeholder="请选择设备分组">
              <el-option
