      ...
      <el-card class="stat-card" shadow="never">
        <div class="flex flex-col">
          <div class="flex justify-between items-center mb-1">
            ...
            <Icon class="text-[32px] text-blue-400" icon="ep:menu" />
          </div>
      ...
      <el-card class="stat-card" shadow="never">
        <div class="flex flex-col">
          <div class="flex justify-between items-center mb-1">
            ...
            <Icon class="text-[32px] text-orange-400" icon="ep:box" />
          </div>
      ...
      <el-card class="stat-card" shadow="never">
        <div class="flex flex-col">
          <div class="flex justify-between items-center mb-1">
            ...
            <Icon class="text-[32px] text-purple-400" icon="ep:cpu" />
          </div>
      ...
      <el-card class="stat-card" shadow="never">
        <div class="flex flex-col">
          <div class="flex justify-between items-center mb-1">
            ...
            <Icon class="text-[32px] text-teal-400" icon="ep:message" />
          </div>
          <span class="text-3xl font-bold text-gray-700">
