...
<template>
  ...
  <el-card class="mt-16px" shadow="never">
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" label="跟进方式" min-width="200" prop="followUpType">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.CRM_FOLLOW_UP_TYPE" :value="scope.row.followUpType" />
        </template>
      </el-table-column>
      <el-table-column align="center" label="个数" min-width="200" prop="followUpRecordCount" />
      <el-table-column align="center" label="占比(%)" min-width="200" prop="portion" />
    </el-table>
  </el-card>
</template>
