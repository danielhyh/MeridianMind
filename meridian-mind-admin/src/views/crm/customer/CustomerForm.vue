      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="客户来源" prop="source">
            <el-select v-model="formData.source" class="w-1/1" placeholder="请选择客户来源">
              <el-option
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="客户行业" prop="industryId">
            <el-select v-model="formData.industryId" class="w-1/1" placeholder="请选择客户行业">
              <el-option
        ...
        <el-col :span="12">
          <el-form-item label="客户级别" prop="level">
            <el-select v-model="formData.level" class="w-1/1" placeholder="请选择客户级别">
              <el-option
