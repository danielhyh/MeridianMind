<template>
  ...
  <Dialog v-model="dialogVisible" title="订单核销" width="35%">
    <el-form
      ...
      label-width="100px"
    >
      <el-form-item label="核销码" prop="pickUpVerifyCode">
        <el-input v-model="formData.pickUpVerifyCode" placeholder="请输入核销码" />
      </el-form-item>
    </el-form>
    <template #footer>
      <el-button :disabled="formLoading" type="primary" @click="getOrderByPickUpVerifyCodeClick">
        查询
      </el-button>
  ...
  <Dialog v-model="detailDialogVisible" title="订单详情" width="55%">
    ...
    <template #footer>
      <el-button :disabled="formLoading" type="primary" @click="submitForm"> 确认核销 </el-button>
