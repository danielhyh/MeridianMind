<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="60%">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="门店 logo" prop="logo">
            <UploadImg v-model="formData.logo" :is-show-tip="false" :limit="1" />
            <div class="pl-10px" style="font-size: 10px">推荐 180x180 图片分辨率</div>
          </el-form-item>
        </el-col>
        <el-col :span="12">
    ...
    <el-dialog v-model="mapDialogVisible" append-to-body title="获取经纬度">
      <IFrame :src="tencentLbsUrl" class="h-609px" />
    </el-dialog>
  </Dialog>
</template>
