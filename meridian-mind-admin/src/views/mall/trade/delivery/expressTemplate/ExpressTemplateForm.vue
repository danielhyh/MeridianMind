  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="1300px">
    ...
    >
      ...
      <el-form-item label="运费" prop="charges">
        <el-table :data="formData.charges" border style="width: 100%">
          ...
          <el-table-column align="center" label="运费(元)" prop="startPrice" width="180">
            <template #default="{ row }">
          ...
          <el-table-column align="center" label="续费(元)" prop="extraPrice" width="180">
            <template #default="{ row }">
      ...
      <el-form-item>
        <el-button plain type="primary" @click="addChargeArea()">
          <Icon class="mr-5px" icon="ep:plus" /> 添加区域
        </el-button>
      </el-form-item>
      <el-form-item label="包邮区域" prop="frees">
        <el-table :data="formData.frees" border style="width: 100%">
          <el-table-column align="center" label="区域" width="360">
            <template #default="{ row }">
              <el-cascader
                v-model="row.areaIds"
          ...
          <el-table-column :label="columnTitle.freeCountTitle" align="center" prop="freeCount">
            <template #default="{ row }">
      ...
      <el-form-item>
        <el-button plain type="primary" @click="addFreeArea()">
          <Icon class="mr-5px" icon="ep:plus" /> 添加区域
        </el-button>
      </el-form-item>
