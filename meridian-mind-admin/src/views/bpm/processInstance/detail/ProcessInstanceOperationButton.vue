<template>
  ...
  >
    ...
    >
      ...
      <!-- 审批表单 -->
      <div v-loading="formLoading" class="flex flex-col flex-1 pt-20px px-20px">
        <el-form
          ref="approveFormRef"
    ...
    >
      <template #reference>
        <div class="hover-bg-gray-100 rounded-xl p-6px" @click="openPopover('copy')">
    ...
    >
      <template #reference>
        <div class="hover-bg-gray-100 rounded-xl p-6px" @click="openPopover('transfer')">
    ...
    >
      <template #reference>
        <div class="hover-bg-gray-100 rounded-xl p-6px" @click="openPopover('delegate')">
    ...
    >
      <template #reference>
        <div class="hover-bg-gray-100 rounded-xl p-6px" @click="openPopover('addSign')">
      ...
      <div v-loading="formLoading" class="flex flex-col flex-1 pt-20px px-20px">
        ...
        >
          <el-form-item label="加签处理人" prop="addSignUserIds">
            <el-select v-model="addSignForm.addSignUserIds" clearable multiple style="width: 100%">
              <el-option
                v-for="item in userOptions"
                :key="item.id"
                :label="item.nickname"
    ...
    >
      <template #reference>
        <div class="hover-bg-gray-100 rounded-xl p-6px" @click="openPopover('deleteSign')">
    ...
    >
      <template #reference>
        <div class="hover-bg-gray-100 rounded-xl p-6px" @click="openPopover('return')">
    ...
    >
      <template #reference>
        <div class="hover-bg-gray-100 rounded-xl p-6px" @click="openPopover('cancel')">
