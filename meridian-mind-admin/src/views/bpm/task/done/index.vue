<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item :style="{ position: 'absolute', right: '300px' }" label="" prop="category">
        <el-select
      ...
      <el-form-item :style="{ position: 'absolute', right: '130px' }" label="" prop="status">
        <el-select
      ...
      <el-form-item :style="{ position: 'absolute', right: '0px' }">
        ...
        >
          ...
          <el-form-item class="bold-label" label="发起时间" label-position="top" prop="createTime">
            <el-date-picker
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" label="审批建议" min-width="180" prop="reason" />
