  ...
  <ContentWrap>
    <div class="flex justify-between pl-20px items-center">
      ...
      <el-form
        ...
        @submit.prevent
      >
        <el-form-item class="ml-auto" prop="name">
          <el-input
          ...
          >
            <template #prefix>
              <Icon class="mx-10px" icon="ep:search" />
            </template>
          </el-input>
        </el-form-item>
        <!-- 右上角：新建模型、更多操作 -->
        <el-form-item>
          <el-button v-hasPermi="['bpm:model:create']" type="primary" @click="openForm('create')">
            <Icon class="mr-5px" icon="ep:plus" /> 新建模型
          </el-button>
        </el-form-item>
        <el-form-item>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item command="handleCategoryAdd">
                  <Icon :size="13" class="mr-5px" icon="ep:circle-plus" />
                  新建分类
                </el-dropdown-item>
                <el-dropdown-item command="handleCategorySort">
                  <Icon :size="13" class="mr-5px" icon="fa:sort-amount-desc" />
                  分类排序
                </el-dropdown-item>
              </el-dropdown-menu>
            </template>
