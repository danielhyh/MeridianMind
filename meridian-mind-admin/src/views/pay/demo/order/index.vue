<template>
  ...
  <el-row :gutter="10" class="mb8">
    <el-col :span="1.5">
      <el-button plain type="primary" @click="openForm"><Icon icon="ep:plus" />发起订单</el-button>
    </el-col>
  </el-row>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" label="商品名字" prop="spuName" />
      ...
      <el-table-column
        ...
        width="180"
      />
      <el-table-column align="center" label="支付单号" prop="payOrderId" />
      <el-table-column align="center" label="是否支付" prop="payStatus">
        <template #default="scope">
...
<script lang="ts" name="PayDemoOrder" setup>
