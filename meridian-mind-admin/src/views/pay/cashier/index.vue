<template>
  ...
  <!-- 支付选择框 -->
  <el-card v-loading="submitLoading" element-loading-text="提交支付中..." style="margin-top: 10px">
    <!-- 支付宝 -->
    ...
    <!-- 微信支付 -->
    <el-descriptions style="margin-top: 20px" title="选择微信支付" />
    <div class="pay-channel-container">
      <div
    ...
    <!-- 其它支付 -->
    <el-descriptions style="margin-top: 20px" title="选择其它支付" />
    <div class="pay-channel-container">
      <div
