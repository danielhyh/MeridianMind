<template>
  <Dialog v-model="dialogVisible" title="发起转账" width="800px">
    <el-card style="margin-top: 10px">
      <el-descriptions :column="2" border title="转账信息">
        ...
        <el-descriptions-item v-if="transfer.type === 1" label="支付宝登录账号">
          {{ transfer.alipayLogonId }}
        </el-descriptions-item>
        <el-descriptions-item v-if="transfer.type === 2" label="微信 openid">
          {{ transfer.openid }}
        </el-descriptions-item>
      </el-descriptions>
    </el-card>
