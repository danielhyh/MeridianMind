  ...
  <Dialog v-model="dialogVisible" title="转账单详情" width="700px">
    <el-descriptions :column="2" label-class-name="desc-label">
      ...
      <el-descriptions-item label="转账单号">
        <el-tag v-if="detailData.no" size="small" type="warning">{{ detailData.no }}</el-tag>
      </el-descriptions-item>
      ...
      <el-descriptions-item label="转账金额">
        <el-tag size="small" type="success">￥{{ (detailData.price / 100.0).toFixed(2) }}</el-tag>
      </el-descriptions-item>
    ...
    <el-descriptions :column="2" label-class-name="desc-label">
      ...
      <el-descriptions-item v-if="detailData.type === 1" label="支付宝登录账号">
        {{ detailData.alipayLogonId }}
      </el-descriptions-item>
      <el-descriptions-item v-if="detailData.type === 2" label="微信 openid">
        {{ detailData.openid }}
      </el-descriptions-item>
      ...
      <el-descriptions-item label="渠道单号">
        <el-tag v-if="detailData.channelTransferNo" size="mini" type="success">
    ...
    <el-divider />
    <el-descriptions :column="1" border direction="vertical" label-class-name="desc-label">
