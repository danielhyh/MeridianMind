<template>
  <!-- 搜索工作栏 -->
  <ContentWrap>
    <el-form ref="queryForm" :inline="true" class="-mb-15px" label-width="68px">
    ...
    <el-row>
      <el-col :span="12" class="card-box">
        <el-card>
          ...
          <Echart :height="420" :options="userSummaryOption" />
        </el-card>
      </el-col>
      <el-col :span="12" class="card-box">
        <el-card>
          ...
          <Echart :height="420" :options="userCumulateOption" />
        </el-card>
      </el-col>
      <el-col :span="12" class="card-box">
        <el-card>
          ...
          <Echart :height="420" :options="upstreamMessageOption" />
        </el-card>
      </el-col>
      <el-col :span="12" class="card-box">
        <el-card>
          ...
          <Echart :height="420" :options="interfaceSummaryOption" />
        </el-card>
      </el-col>
    </el-row>
  </ContentWrap>
