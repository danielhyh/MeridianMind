  ...
  <ContentWrap>
    <el-tabs v-model="msgType" @tab-change="onTabChange">
      ...
      <el-tab-pane :name="MsgType.Follow">
        <template #label>
          <el-row align="middle"><Icon class="mr-2px" icon="ep:star" /> 关注时回复</el-row>
        </template>
      </el-tab-pane>
      <el-tab-pane :name="MsgType.Message">
        <template #label>
          <el-row align="middle"><Icon class="mr-2px" icon="ep:chat-line-round" /> 消息回复</el-row>
        </template>
      </el-tab-pane>
      <el-tab-pane :name="MsgType.Keyword">
        <template #label>
          <el-row align="middle"><Icon class="mr-2px" icon="fa:newspaper-o" /> 关键词回复</el-row>
        </template>
      </el-tab-pane>
    </el-tabs>
    <!-- 列表 -->
